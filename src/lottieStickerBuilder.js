...
function normalizeTemplateFiles(templateFiles = null) {
    ...
    const normalized = {
        ...
        animationTrustTokenText: typeof templateFiles.animationTrustTokenText === 'string'
            ? templateFiles.animationTrustTokenText
            : '',
        animationSecondaryTrustTokenText: typeof templateFiles.animationSecondaryTrustTokenText === 'string'
            ? templateFiles.animationSecondaryTrustTokenText
            : ''
    };

    const missing = Object.entries({
        animationJsonText: normalized.animationJsonText,
        animationSecondaryJsonText: normalized.animationSecondaryJsonText
    })
